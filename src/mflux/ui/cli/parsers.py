...
class CommandLineParser(argparse.ArgumentParser):
    ...
    def add_image_generator_arguments(self, supports_metadata_config=False) -> None:
        ...
        prompt_group.add_argument("--dual-prompts", "--dual_prompts", dest="dual_prompts", action="store_true", help="Enable dual prompts mode to use separate prompts for CLIP and T5 encoders.")
        prompt_group.add_argument("--clip-prompt", "--clip_prompt", dest="clip_prompt", type=str, default=None, help="The textual description for the CLIP encoder when dual prompts mode is enabled.")
